...
class SchemaBase extends PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        $sqls = [
            "CREATE TABLE IF NOT EXISTS arcanetest ( id INT PRIMARY KEY AUTO_INCREMENT, foo VARCHAR(32), ts timestamp default current_timestamp on update current_timestamp)",
